...
function Header() {
  ...
  return (
    <div className={cs("wrapper-h")}>
      <div className={cs("nav-wrapper")}>
        <div className={cs("left-menu")}>
          <img className={cs("logo-he")} src={images.logo} alt="logo" />
          <a className={cs("new-version")} href="/">
            <img className={cs("ic-new")} src={images.icNew} alt="ic new" />
          </a>
          {category.map((cate) => (
            <Tippy
              placement="bottom"
              interactive
              key={cate.id}
              render={(attrs) => <Menu {...attrs} typeMenu={cate.title} />}
            >
              <a className={cs("option-left-menu")} href="/">
                <Button btnHeader>
                  {cate.title === "More" ? (
                    <img
                      className={cs("ic-more")}
                      src={images.icMore}
                      alt="icon more"
                    />
                  ) : (
        ...
        <div className={cs("right-menu")}>
          ...
          <Button btnHeader>
            <img
              className={cs("ic-store")}
              src={images.icStore}
              alt="ic store"
            />
          </Button>
          <Button upload btnHeader>
            <img
              className={cs("ic-upload")}
              src={images.icUpload}
              alt="ic upload"
            />
          </Button>
